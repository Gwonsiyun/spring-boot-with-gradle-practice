		...
		<ul class="row navbar list-unstyled" id="mainNavbar">
			...
			<c:if test="${loginUser != null && loginUser.grade ne 'A' && loginUser.grade ne 'M'}">
				<li class="col-md-2 mainMenu" id="navProfile" onclick="location.href='${pageContext.request.contextPath}/mypage/mypage.do'">
					<img id="navProfileImg" src="${pageContext.request.contextPath}/resources/image/${loginUser.profile_system}" alt="유저 프로필 사진"> ${loginUser.nick_name}
				</li>
			</c:if>
			<c:if test="${naverUser != null}">
				<li class="col-md-2 mainMenu" id="navProfile" onclick="location.href='${pageContext.request.contextPath}/mypage/mypage.do'">
					<img id="navProfileImg" src="${pageContext.request.contextPath}/resources/image/${naverUser.profile_system}" alt="유저 프로필 사진"> ${naverUser.nick_name}
				</li>
			</c:if>
			<c:if test="${kakaoUser != null}">
				<li class="col-md-2 mainMenu" id="navProfile" onclick="location.href='${pageContext.request.contextPath}/mypage/mypage.do'">
					<img id="navProfileImg" src="${pageContext.request.contextPath}/resources/image/${kakaoUser.profile_system}" alt="유저 프로필 사진"> ${kakaoUser.nick_name}
				</li>
			</c:if>
			<%-- <c:if test="${facebookUser != null}">
				<li class="col-md-2 mainMenu" id="navProfile" onclick="location.href='${pageContext.request.contextPath}/mypage/mypage.do'">
					<img id="navProfileImg" src="${pageContext.request.contextPath}/resources/image/${facebookUser.profile_system}" alt="유저 프로필 사진"> ${facebookUser.nick_name}
				</li>
			</c:if> --%>
