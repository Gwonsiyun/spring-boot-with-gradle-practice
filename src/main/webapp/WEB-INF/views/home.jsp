		...
		<div class="row storyList">
			...
			<c:forEach items="${list}" var="vo" varStatus="cnt">
				<div id="storyList${cnt.count }" class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 story">
					<img src="${pageContext.request.contextPath}/resources/upload/${vo.img_system }" class="storyImg" onclick="location.href='${pageContext.request.contextPath}/community/home_view.do?cbidx=${vo.cbidx}&fmidx=${vo.midx }&nowPage=1'" alt="${vo.title }">
					<div class="storyText">
						...
						<div class="storyWriter" onclick="location.href='${pageContext.request.contextPath}/mypage/Member_page.do?midx=${vo.midx}'">
							<img class="writerImg" src="${pageContext.request.contextPath}/resources/image/${vo.profile_system }" alt="게시글 작성자 사진">${vo.writer }
						</div>
					</div>
				</div>
			</c:forEach>
		...
		<div class="row shopList">
			...
			<c:forEach items="${storeList}" end="3" var="storeListvo" varStatus="cnt">
				<div id="storeList${cnt.count }" class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 shop">
					<img src="${pageContext.request.contextPath}/resources/image/${storeListvo.img_system }" class="shopImg" onclick="location.href='${pageContext.request.contextPath}/store/store_view.do?spidx=${storeListvo.spidx}'">
