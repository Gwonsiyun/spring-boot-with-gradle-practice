...
<head>
   ...
   <script src="https://unpkg.com/sweetalert/dist/sweetalert.min.js"></script>
	...
	<link href="/resources/css/store/store_common.css" rel="stylesheet">
	<link href="/resources/css/footer.css" rel="stylesheet">
	<link href="/resources/css/store/store.css" rel="stylesheet">
	<script src="/resources/js/jquery-3.6.0.min.js"></script>
	<script src="/resources/js/nav.js"></script>
	<script src="/resources/js/header.js"></script>
	<script src="/resources/js/home.js"></script>
	<script src="/resources/js/store/store.js"></script>
...
<body>
	...
	<section>
		...
		<!-- 이벤트 베너 -->
		<div class="row">
			<img class="col-12" src="${pageContext.request.contextPath}/resources/image/store_van.jpg">
		</div>
		...
		<div class="row category">
			<div id="10" class="category_link col-4 col-sm-2 col-md-2 col-lg-2 col-xl-2">
				<div class="img_box">
					<img class="category_img" src="${pageContext.request.contextPath}/resources/image/furniture.png"><br>
				</div>
				가구
			</div>
			<div id="30" class="category_link col-4 col-sm-2 col-md-2 col-lg-2 col-xl-2">
				<div class="img_box">
					<img class="category_img" src="${pageContext.request.contextPath}/resources/image/bedding.png"><br>
				</div>
				침구
			</div>
			<div id="40" class="category_link col-4 col-sm-2 col-md-2 col-lg-2 col-xl-2">
				<div class="img_box">
					<img id="big_img" class="category_img" src="${pageContext.request.contextPath}/resources/image/appliances.png"><br>
				</div>
				가전
			</div>
			<div id="20" class="category_link col-4 col-sm-2 col-md-2 col-lg-2 col-xl-2">
				<div class="img_box">
					<img class="category_img" src="${pageContext.request.contextPath}/resources/image/light.png"><br>
				</div>
				조명
			</div>
			<div id="50" class="category_link col-4 col-sm-2 col-md-2 col-lg-2 col-xl-2">
				<div class="img_box">
					<img class="category_img" src="${pageContext.request.contextPath}/resources/image/kitchen.png"><br>
				</div>
				주방
			</div>
			<div id="60" class="category_link col-4 col-sm-2 col-md-2 col-lg-2 col-xl-2">
				<div class="img_box">
					<img class="category_img" src="${pageContext.request.contextPath}/resources/image/daily.png"><br>
				</div>
				생활
			</div>
			...
			<div class="row shopList">
		       ...
		       <c:forEach items="${list.get(0)}" var="vo" end="3" varStatus="cnt">
				<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 shop" <c:if test="${cnt.last}">id="mdlg_display_none"</c:if> onClick="location.href='${pageContext.request.contextPath}/store/store_view.do?spidx=${vo.spidx}'">
					<img src="${pageContext.request.contextPath}/resources/image/${vo.img_system}" class="shopImg" onClick="">
