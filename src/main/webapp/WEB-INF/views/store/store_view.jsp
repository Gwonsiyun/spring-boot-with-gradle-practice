...
<head>
   ...
   <script src="https://static.nid.naver.com/js/naveridlogin_js_sdk_2.0.2.js" charset="utf-8"></script>
	...
	<link href="/resources/css/store/view.css" rel="stylesheet">
	<script src="/resources/js/nav.js"></script>
	<script src="/resources/js/header.js"></script>
	<script src="/resources/js/store/view.js"></script>
...
<body>
	...
	<section id="Shop_area">
		<c:if test="${loginUser.grade eq 'A'}">
			<div id="sv_md">
				<button onClick="location.href='/store/store_modify.do?spidx=${vo.spidx}'">상품수정</button>
		...
		<div class="row" id="shop_content">
			<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
				<img src= "/resources/image/${vo.img_system}" class="shopImg" onClick="">
			</div>
							...
							<c:forEach items="${rvo}" var="rvo">
								<li class="reply_list_item">
									<article class="reply_item_">
										<p class="reply_item_content">
											<a class="reply_item_content_writer" href="javascript:void(0)">${rvo.nick_name}
												<img class="reply_item_content_writer_image" src="/resources/image/${rvo.profile_system }">
											</a>
									...
									<c:if test="${not empty rvo.img_origin && rvo.img_origin ne ''}">
										<div style="padding: 5px; width: 150px; height: 150px;"><img alt="" src="/resources/image/${rvo.img_system}" style="width: 100%; height: 100%;border-radius: 5px;"> </div>
									</c:if>
			...
			if(${!empty loginUser}){
				...
				swal({
	                  ...
	                  closeOnClickOutside : false
	            	   ...
	            	   location.href="/resources/login/login.do"
	               });
