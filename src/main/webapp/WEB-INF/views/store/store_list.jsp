...
<head>
	...
	<link href="/resources/css/store/store_list.css" rel="stylesheet">
	<script src="/resources/js/jquery-3.6.0.min.js"></script>
	<script src="/resources/js/nav.js"></script>
	<script src="/resources/js/header.js"></script>
	<script src="/resources/js/home.js"></script>
	<script src="/resources/js/store/store_list.js"></script>
				...
				<div id="deal">
					<div class="row shopList">
						...
						<div class="col-12 col-sm-6 col-md-4 col-lg-4 col-xl-3 shop" onClick="location.href='${pageContext.request.contextPath}/store/store_view.do?spidx=${vo.spidx}'">
							<img src="${pageContext.request.contextPath}/resources/image/${vo.img_system}" class="shopImg">
							<div class="shopText">
								<div class="shopTitle">
