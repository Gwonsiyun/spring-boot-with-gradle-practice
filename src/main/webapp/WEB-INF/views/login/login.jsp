...
<body>
		...
		<div class="login_wrap container-fluid">  
			<div class="row">
				<div id="loginArea" class="col-12 col-sm-8" style="float: none; margin:0 auto;">
					...
					<form id="frm" method="post" action="/loginProc">
						<div>
							<input type="text" name="id" id="id" placeholder="  이메일" onkeyup="enterkey();">
						</div>
						<div> 
							<input type="password" name="pwd" id="pwd" placeholder="  비밀번호" onkeyup="enterkey();">
						</div>
						<div>
					...
					<div> 
						...
						<div>
							<div id="naver_id_login" class="snsLoginButton" style="text-align:center">
								<a href="${url}">
									<img id=""naver src="/resources/image/naverButton2.png">
								</a>
							</div>
							<div class="snsLoginButton">
								<img id="kakao" onclick="kakaoLogin();" src="/resources/image/kakaoButton2.png">
							</div>
						</div>
					</div>
				</div>
	...
	<script src="/resources/js/login/login2.js"></script>
