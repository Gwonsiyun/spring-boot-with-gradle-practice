...
<head>
	...
	<link href="/resources/css/mypage/payment.css" rel="stylesheet">
	<link href="/resources/css/footer.css" rel="stylesheet">
	
	<script src="/resources/js/jquery-3.6.0.min.js"></script>
	<script src="/resources/js/header.js"></script>
	<script src="/resources/js/nav.js"></script>
	<script src="/resources/js/mypage/payment1.js"></script>
					...
					<div class="productArea">
						...
						<div class="productDetail row">
							<div class="productImgDiv col-4 col-md-4 col-lg-3">
								<img src="/resources/image/${basketListvo.img_system}" class="productImg" alt=""
