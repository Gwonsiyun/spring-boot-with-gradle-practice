...
<head>
	...
	<link href="/resources/css/mypage/basket.css" rel="stylesheet">
	
	<script src="/resources/js/jquery-3.6.0.min.js"></script>
	<script src="/resources/js/header.js"></script>
	<script src="/resources/js/nav.js"></script>
	<script src="/resources/js/home.js"></script>
	<script src="/resources/js/mypage/basket.js"></script>
					...
					<c:forEach items="${basketListAll}" var="basketListAllvo" varStatus="cnt">
						...
						<ul class="row no_list container-fluid border_b" id="basket${basketListAllvo.sbidx}">
							...
							<li class="col-3">
								...
								<li class="col-3"></li>
									<li class="col-9">
										<img class="product_image" src="/resources/image/${basketListAllvo.img_system}">
									</li>
								</ul>
							</li>
							<li class="col-9">
